...
A partir do momento em que num dia tinha centenas de chamadas foi sempre uma pressão constante para estar atento funcionamento do servidor, se os limites da API não estavam a ser ultrapassados e para lançar mais updates ao bot. Isto também contribuiu em parte para o término do mesmo.
